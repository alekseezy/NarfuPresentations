...
{
    Task<PaginationResponse<UserDetailsResponse>> SearchAsync(UsersFilter filter, CancellationToken cancellationToken);
    ...
    Task<IEnumerable<UserRoleResponse>> GetRolesAsync(string userId, CancellationToken cancellationToken);
    Task<string> AssignRolesAsync(string userId, AssignUserRolesRequest request, CancellationToken cancellationToken);

    Task<IEnumerable<string>> GetPermissionsAsync(string userId, CancellationToken cancellationToken);
